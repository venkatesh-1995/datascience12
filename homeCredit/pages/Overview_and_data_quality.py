...
with col2:
  ...
  st.write("### Boxplot — AMT_INCOME_TOTAL")
  fig, ax = plt.subplots(figsize=(8, 5))
  sns.boxplot(data=df, y="AMT_INCOME_TOTAL", palette="Set2", ax=ax)
  ax.set_title("Boxplot of Income Total")
...
with col1:
   ...
   st.write("### Boxplot — AMT_CREDIT")
   fig, ax = plt.subplots(figsize=(8, 5))
   sns.boxplot(data=df, y="AMT_CREDIT", palette="Set3", ax=ax)
   ax.set_title("Boxplot of Credit Amount")
